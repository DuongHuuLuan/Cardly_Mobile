    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            width: 80,
            child: Text(label, style: AppTextStyles.bodySmall.copyWith(color: AppColor.grey)),
          ),
          Expanded(
            child: Text(value, style: AppTextStyles.bodyMedium.copyWith(color: AppColor.black87)),
          ),
        ],
      ),
    );
